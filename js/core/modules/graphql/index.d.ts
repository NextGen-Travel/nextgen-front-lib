...
export declare class Graphql<D extends Record<string, {
    ...
    query<K extends keyof D, V = Parameters<NonNullable<D[K]['__apiType']>>[0], R = ReturnType<NonNullable<D[K]['__apiType']>>>(name: K, variable: V): Promise<{ [K_2 in keyof { [K_1 in keyof R]-?: NonNullable<R[K_1]>; }]: { [K_1 in keyof R]-?: NonNullable<R[K_1]>; }[K_2] extends StrapiList<StrapiData[], Record<string, any>> ? ResultToStrapiList<{ [K_1 in keyof R]-?: NonNullable<R[K_1]>; }[K_2]["data"], { [K_1 in keyof R]-?: NonNullable<R[K_1]>; }[K_2]["meta"]> : { [K_1 in keyof R]-?: NonNullable<R[K_1]>; }[K_2] extends {
        data?: StrapiData | undefined;
    } ? ResultToStrapiData<NonNullable<{ [K_1 in keyof R]-?: NonNullable<R[K_1]>; }[K_2]["data"]>> : { [K_1 in keyof R]-?: NonNullable<R[K_1]>; }[K_2]; }>;
}
export {};
